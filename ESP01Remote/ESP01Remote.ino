...
void handle_SaveSetting() {
  ...
  String APIpAddress = server.arg("APIpAddress");
  String ClientSSID = server.arg("SSID");
  String password = server.arg("password");
  String TShift = server.arg("TShift");
  // todo: здесь сохранение
