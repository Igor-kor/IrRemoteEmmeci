...
<head>
    ...
    .btn2 {
        background: linear-gradient(90deg, #4764b3, #00e6ff);
    }

    .btn3 {
        background: linear-gradient(90deg, #feff36, #cc481f);
    }

    .btn4 {
        background: linear-gradient(90deg, #c77474, #b224d4);
    }

    .btn5 {
        background: linear-gradient(90deg, #ff1a1a, #d8ba46);
    }
    .btn-save {
        background: linear-gradient(90deg, #454545, #212121);
    }
...
<div id="webpage">
    ...
    <div class="setting">
        <svg   id="Layer_4" xmlns="http://www.w3.org/2000/svg"
             x="0px" y="0px" width="30px" height="30px"
             viewBox="0 0 286.036 286.036" style=":new 0 0 286.036 286.036;" xml:space="preserve">
            <g>
    ...
    <div class="data">
        <div class="side-by-side temperature-icon">
            <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                  x="0px" y="0px" width="9.915px" height="22px"
                 viewBox="0 0 9.915 22" enable-background="new 0 0 9.915 22" xml:space="preserve">
    ...
    <div class="data">
        <div class="side-by-side humidity-icon">
            <svg id="Layer_2" xmlns="http://www.w3.org/2000/svg"
                 x="0px" y="0px" width="12px" height="17.955px" viewBox="0 0 13 17.955" enable-background="new 0 0 13 17.955"
            xml:space="preserve">
...
c-0.438,1.574-2.264,4.681-6.252,4.681c-3.988,0-5.813-3.107-6.252-4.681C-0.313,11.267,0.026,9.143,1.819,6.217"></path>
    ...
    <button class="btn btn1" onclick="sendButtonClick(0);">SWING</button>
    <button class="btn btn2" onclick="sendButtonClick(1);">COOL</button>
    <button class="btn btn3" onclick="sendButtonClick(2);">TIMER</button>
    <button class="btn btn4" onclick="sendButtonClick(3);">SPEED</button>
    <button class="btn btn5" onclick="sendButtonClick(4);">OFF</button>

    <div id="myModal" class="modal">
        <div class="modal-content">
            <span class="close">&times;</span>
            <div class="modal-center">Settings</div>
            <form class="modal-form">
                <label>Wifi AP SSID
                    <input name="APSSID" type="text">
                </label>
                <label>Wifi AP password
                    <input name="APPassword" type="text">
                </label>
                <label>Wifi AP ip address
                    <input name="APIpAddress" type="text">
                </label>
                <label>Wifi connected SSID
                    <input name="SSID" type="text">
                </label>
                <label>Wifi connected password
                    <input name="password" type="text">
                </label>
                <label>Temperature shift
                    <input name="TShift" type="text">
                </label>
                    <button class="btn btn-save" name="btn-modal" type="button">save</button>
            </form>
        </div>
    </div>
</div>
